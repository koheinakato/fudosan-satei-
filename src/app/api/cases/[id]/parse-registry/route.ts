...
【重要な注意】
- 権利部（甲区）の所有者欄に記載された住所は「所有者の住所（旧住所のことも多い）」であり、物件の所在地ではありません。
  所有者住所やそこに含まれる建物名（アパート名・マンション名）を jyukyoHyoji や propertyName に使ってはいけません。
- jyukyoHyoji は表題部に物件自体の住居表示が明記されている場合のみ記載し、なければ null にしてください。
- propertyName の付け方:
  - 区分マンション: 表題部「建物の名称」欄の名称（＋家屋番号から分かる部屋番号）。
  - 戸建て・土地: 「物件所在の町名 ＋ 権利部の最新所有者の姓 ＋ 様邸」（例: 山崎一丁目 田中様邸）。所有者名が不明なら町名のみ。
...
{
  "address": "所在地（地番）",
  "jyukyoHyoji": "物件自体の住居表示（表題部に記載がある場合のみ。なければnull）",
  "chiban": "地番",
  "kaheiNumber": "家屋番号",
  "landArea": 土地面積(数値, ㎡),
  "floorArea": 建物床面積(数値, ㎡),
