...
export default function Home() {
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <section className="border-b border-[#ced4da] overflow-hidden">
        <div className="max-w-5xl mx-auto flex items-center min-h-[520px]">
      ...
      {/* サンプルレポート */}
      <section className="py-20 border-b border-[#ced4da]">
      ...
      {/* 料金 × 筆数とは */}
      <section className="border-b border-[#ced4da]">
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2">
          ...
          <div className="px-8 py-20 md:px-12">
            ...
            <div className="space-y-8">
              {[
                { step: '01', title: '情報を入力（無料）', desc: '住所・物件種別・査定目的の3項目を入力するだけ。' },
          ...
          {/* 運営会社 */}
          <div className="px-8 py-20 md:px-12">
            <p className="label-nendo border-b border-[#ced4da] pb-2 mb-8">運営会社</p>
            <div className="space-y-0">
              {[
                { label: '会社名', value: 'ぷらたなすきかく株式会社' },
                { label: '創業', value: '2024年05月' },
                { label: '所在地', value: '〒737-0811 広島県呉市西中央3-19-6' },
                { label: '代表取締役', value: '中藤 宏平' },
                { label: '取締役', value: '麻生 啓太' },
              ].map((row) => (
                <div key={row.label} className="py-4 border-b border-[#ced4da]">
                  <p className="font-helvetica text-[10px] tracking-[0.08em] text-[#5a5a5a] uppercase mb-1">{row.label}</p>
                  <p className="text-sm text-[#212529]">{row.value}</p>
                </div>
              ))}
            </div>
          </div>
